  ...
  return (
    <div onClick={e => handleClick(e)} className='min-h-screen text-gray-800'>
      ...
      <main className='font-lora flex flex-col items-center mx-auto mb-64'>
        <div className={`background-pattern w-full ${hasImage ? 'h-56' : 'h-48'}`}></div>
        <section className={`${hasImage ? '-mt-28' : '-mt-32 pt-10'} mb-8 bg-white p-8 sm:rounded-xl shadow max-w-lg mx-auto w-full`}>
          <div className={`${hasImage ? 'block' : 'hidden'} mb-4 -mt-28 border-4 border-white rounded-full w-36 h-36 bg-gray-50 mx-auto`}></div>
          {/* <p contentEditable className={`mb-6 w-full placeholder:text-gray-800 focus:placeholder:text-gray-400 hover:border focus:border hover:border-gray-300 rounded-lg font-lora text-4xl font-medium text-center   transition duration-200 focus:outline-none focus:ring-1  focus:ring-blue-500 focus:border-blue-500`}>Revoke Access to your Loot Bag</p> */}
          <textarea rows='1' autoFocus onFocus={e => e.target.select()} type="text" placeholder="Add a Title..." className={`mb-4 w-full placeholder:text-gray-800 focus:placeholder:text-gray-400 hover:ring-1 hover:ring-gray-300 focus:ring-2 rounded-lg font-lora text-4xl font-medium text-center   transition duration-200 focus:outline-none  focus:ring-blue-500 focus:border-blue-500`} />
          <textarea rows="1" onFocus={e => e.target.select()} placeholder="Add a description..." className='w-full text-gray-500 placeholder:text-gray-500 focus:placeholder:text-gray-400 hover:ring-1 hover:ring-gray-300 focus:ring-2 rounded-md font-lora text-center mb-6 transition duration-200 focus:outline-none focus:ring-blue-500 focus:border-blue-500'/>
        ...
        <div className='space-y-8'>
          <div ref={field1} id={field1} className='w-full'>
            <div className='p-8 w-full max-w-lg mx-auto rounded-lg hover:ring-1 hover:ring-gray-200 transition duration-200'>
              <div className=''>
                <div className='flex items-baseline justify-between'>
                  <h2 name="title" className='text-2xl mb-4 mr-4'>renounceOwnership</h2>
          ...
          <div ref={field2} id={field2} className='w-full border bg-gray-50/90 rounded-lg'>
            <div className='p-8 w-full max-w-lg mx-auto rounded-lg '>
              <div className=''>
                ...
                <input name="title" placeholder="Write a useful prompt..." className='w-full text-2xl mb-2 bg-white border rounded-lg p-2 px-4 transition duration-200 hover:text-gray-800 focus:text-gray-800 hover:border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500'/>
                <input name="description" placeholder="Write some helper text..." className='font-lora rounded-lg mb-6 p-2 px-4 w-full bg-white border transition duration-200 hover:text-gray-800 focus:text-gray-800 hover:border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500'/>
                <div className='flex'>
                  <label className='relative flex flex-col items-start w-full' htmlFor='address'>
                    <input ref={address} 
                           disabled
