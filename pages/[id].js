  ...
  return (
    <div className='relative min-h-screen'>
      <main className='font-lora flex flex-col items-center mx-auto mb-80'>
        ...
        <section className={`-mt-36 sm:-mt-28 mb-8 sm:mb-12 bg-white p-8 pt-12 sm:pt-10 shadow-t sm:shadow rounded-t-xl sm:rounded-xl sm:max-w-lg mx-auto w-full`}>
          <div className='max-w-md mx-auto'>
            ...
            <h2 className='sm:px-4 mb-[23px] pb-1 border-b border-transparent  w-full text-gray-500 font-lora text-center transition duration-200 focus:outline-none'>
              {form.description ? form.description : `This form calls the ${form.method} mehtod from the ${form.contract.name} contract.`}
            </h2>
...
export async function getServerSideProps(context) {
  const forms = await findForms(context.params.id);
